...
const WfcIpImpairment = () => {
    ...
    return (
        <>
            <PageBreak>
                <DynamicHeader level={1} id="WfcImpairment">IP Impairments</DynamicHeader>
                                    ...
                                    {targetTcs.map(tc => {
                                        ...
                                        const renderRow = (deviceType, deviceData, referenceData) => {
                                            ...
                                            if (deviceType === 'DUT') {
                                                ...
                                                if (tc === 'TC171') packetLossVal = 'Call Drop';
                                            }
                                            ...
                                            if (deviceType === 'DUT') {
                                                ...
                                                if (tc === 'TC172' || tc === 'TC173') packetLossStyle = { backgroundColor: 'red' };
                                            }
